...
export class HomeResultsPage {
  ...
  constructor(
    ...
    this.page = 1;
    this.size = 3;
    this.imagePath = URL.createObjectURL('http://193.176.243.61/api/v1/events/download?id=33');
  ...
  async presentImage(image: any) {
   ...
   async getImage(imageid: number) {
       const result = this.apiService.downloadEventImage(imageid);
       console.log(result);
...
/*         const blob = new Blob([result], {
        ...
        reader.onloadend = () => {
          ...
          this.converted_image = URL.createObjectURL(blob);
