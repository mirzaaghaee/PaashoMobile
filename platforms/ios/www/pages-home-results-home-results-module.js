...
var PopmenuComponent = /** @class */ (function () {
    ...
    PopmenuComponent.prototype.routeToPage = function (event) {
        switch (event) {
            case 'home': {
...
/* harmony import */ var _modal_eventdetail_eventdetail_page__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./../modal/eventdetail/eventdetail.page */ "./src/app/pages/modal/eventdetail/eventdetail.page.ts");
...
/* harmony import */ var _services_eventType__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../services/eventType */ "./src/app/services/eventType.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomeResultsPage = /** @class */ (function () {
    function HomeResultsPage(navCtrl, menuCtrl, popoverCtrl, alertCtrl, modalCtrl, toastCtrl, apiService) {
        ...
        this.searchKey = '';
        this.yourLocation = 'Angry Monkey';
        this.themeCover = 'assets/img/ionic4-Start-Theme-cover.jpg';
        this.eventList = [];
        this.eventListPagination = [];
        this.eventtype = _services_eventType__WEBPACK_IMPORTED_MODULE_7__["eventType"].POPULAR;
        this.page = 0;
        this.size = 5;
        this.imagePath = '';
    }
    ...
    HomeResultsPage.prototype.changeFilter = function (eventtype) {
        this.page = 0;
        this.eventList = [];
        this.eventListPagination = [];
    ...
    HomeResultsPage.prototype.getAllEvents = function () {
        ...
        this.apiService.getAllEvents().subscribe(function (response) {
            ...
            for (var i = 0; i < response.length; i++) {
                response[i].imageSrc = _this.apiService.getImageUrl(response[i].pic);
                _this.eventListPagination.push(response[i]);
            }
        });
    };
    HomeResultsPage.prototype.getFilteredEvents = function (eventtype) {
        var _this = this;
        this.apiService.getEventListPagination(eventtype, this.page, this.size).subscribe(function (response) {
            console.log(response);
            for (var i = 0; i < response.length; i++) {
                response[i].imageSrc = _this.apiService.getImageUrl(response[i].pic);
                _this.eventListPagination.push(response[i]);
    ...
    HomeResultsPage.prototype.showEventDetail = function (eventitem) {
        return __awaiter(this, void 0, void 0, function () {
            var modal;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.modalCtrl.create({
                            component: _modal_eventdetail_eventdetail_page__WEBPACK_IMPORTED_MODULE_4__["EventdetailPage"],
